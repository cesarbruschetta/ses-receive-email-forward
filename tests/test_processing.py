...
from forward_recieved_email import config, processing
...
class TestProcessingMainHandler(unittest.TestCase):
    ...
    def test_main_handler(self):
        ...
        conn_ses = boto3.client("ses", region_name=config.AWS_DEFAULT_REGION)
        conn_ses.verify_email_identity(EmailAddress="no-reply@helpec.com.br")        
        
        conn_s3 = boto3.resource('s3', region_name=config.AWS_DEFAULT_REGION)
